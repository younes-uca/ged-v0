...
import Edit from '/pages/module/admin/view/user/utilisateur-admin/edit-admin/utilisateur-edit-admin.component';
import Create from '/pages/module/admin/view/user/utilisateur-admin/create-admin/utilisateur-create-admin.component';
import View from '/pages/module/admin/view/user/utilisateur-admin/view-admin/utilisateur-view-admin.component';
