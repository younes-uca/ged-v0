...
@Tag(name = "Manages acessShare services")
@RestController
...
public class AcessShareRestAdmin  extends AbstractController<AcessShare, AcessShareDto, AcessShareHistory, AcessShareCriteria, AcessShareHistoryCriteria, AcessShareAdminService, AcessShareConverter> {
    ...
    @Operation(summary = "upload one acessShare")
    @RequestMapping(value = "upload", method = RequestMethod.POST, consumes = "multipart/form-data")
    public ResponseEntity<FileTempDto> uploadFileAndGetChecksum(@RequestBody MultipartFile file) throws Exception {
        return super.uploadFileAndGetChecksum(file);
    }
    @Operation(summary = "upload multiple acessShares")
    ...
    @Operation(summary = "Exports acessShares by criteria")
    @PostMapping("export")
    ...
    @Operation(summary = "Gets acessShare history by id")
    @GetMapping("history/id/{id}")
    public ResponseEntity<AuditEntityDto> findHistoryById(@PathVariable("id") Long id) throws Exception {
        return super.findHistoryById(id);
    }

    @Operation(summary = "Gets acessShare paginated history by criteria")
    ...
    @Operation(summary = "Exports acessShare history by criteria")
    ...
    @Operation(summary = "Gets acessShare history data size by criteria")
