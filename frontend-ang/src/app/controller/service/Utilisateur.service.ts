...
import {UtilisateurCriteria} from '../criteria/UtilisateurCriteria.model';
...
export class UtilisateurService extends AbstractService<UtilisateurDto, UtilisateurCriteria> {
