...
@Component({
  selector: 'app-groupe-edit-admin',
  templateUrl: './groupe-edit-admin.component.html'
})
export class GroupeEditAdminComponent extends AbstractEditController<GroupeDto, GroupeCriteria, GroupeService>   implements OnInit {
