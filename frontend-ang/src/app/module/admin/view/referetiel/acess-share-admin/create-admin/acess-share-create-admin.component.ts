...
@Component({
  selector: 'app-acess-share-create-admin',
  templateUrl: './acess-share-create-admin.component.html'
})
export class AcessShareCreateAdminComponent extends AbstractCreateController<AcessShareDto, AcessShareCriteria, AcessShareService>  implements OnInit {
