...
@Component({
  selector: 'app-document-edit-admin',
  templateUrl: './document-edit-admin.component.html'
})
export class DocumentEditAdminComponent extends AbstractEditController<DocumentDto, DocumentCriteria, DocumentService>   implements OnInit {
    ...
    public prepareEdit() {
        this.item.uploadDate = this.documentService.format(this.item.uploadDate);
        this.item.dateLastUpdate = this.documentService.format(this.item.dateLastUpdate);
    }
    ...
    public validateDocumentPartageGroupes(){
        this.errorMessages = new Array();
    }
    public validateDocumentPartageUtilisateurs(){
        this.errorMessages = new Array();
    }
    public validateDocumentManagementGroupes(){
        this.errorMessages = new Array();
    }
    public validateDocumentManagementUtilisateurs(){
        this.errorMessages = new Array();
    }
   ...
   public addDocumentPartageGroupes() {
       ...
       if (this.errorMessages.length === 0) {
            if(this.documentPartageGroupesElement.id == null){
                this.item.documentPartageGroupes.push(this.documentPartageGroupesElement);
            }else{
                const index = this.item.documentPartageGroupes.findIndex(e => e.id == this.documentPartageGroupesElement.id);
                this.item.documentPartageGroupes[index] = this.documentPartageGroupesElement;
            }
   ...
   public addDocumentPartageUtilisateurs() {
       ...
       if (this.errorMessages.length === 0) {
            if(this.documentPartageUtilisateursElement.id == null){
                this.item.documentPartageUtilisateurs.push(this.documentPartageUtilisateursElement);
            }else{
                const index = this.item.documentPartageUtilisateurs.findIndex(e => e.id == this.documentPartageUtilisateursElement.id);
                this.item.documentPartageUtilisateurs[index] = this.documentPartageUtilisateursElement;
            }
   ...
   public addDocumentManagementGroupes() {
       ...
       if (this.errorMessages.length === 0) {
            if(this.documentManagementGroupesElement.id == null){
                this.item.documentManagementGroupes.push(this.documentManagementGroupesElement);
            }else{
                const index = this.item.documentManagementGroupes.findIndex(e => e.id == this.documentManagementGroupesElement.id);
                this.item.documentManagementGroupes[index] = this.documentManagementGroupesElement;
            }
   ...
   public addDocumentManagementUtilisateurs() {
       ...
       if (this.errorMessages.length === 0) {
            if(this.documentManagementUtilisateursElement.id == null){
                this.item.documentManagementUtilisateurs.push(this.documentManagementUtilisateursElement);
            }else{
                const index = this.item.documentManagementUtilisateurs.findIndex(e => e.id == this.documentManagementUtilisateursElement.id);
                this.item.documentManagementUtilisateurs[index] = this.documentManagementUtilisateursElement;
            }
   ...
   public async openCreateDocumentType(documentType: string) {
        const isPermistted = await this.roleService.isPermitted('DocumentType', 'edit');
        if(isPermistted) {
             this.documentType = new DocumentTypeDto();
