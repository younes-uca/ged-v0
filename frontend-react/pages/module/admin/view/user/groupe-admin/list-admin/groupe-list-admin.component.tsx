...
import Edit from '/pages/module/admin/view/user/groupe-admin/edit-admin/groupe-edit-admin.component';
import Create from '/pages/module/admin/view/user/groupe-admin/create-admin/groupe-create-admin.component';
import View from '/pages/module/admin/view/user/groupe-admin/view-admin/groupe-view-admin.component';
