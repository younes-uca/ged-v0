...
import Edit from '/pages/module/admin/view/user/entite-administrative-admin/edit-admin/entite-administrative-edit-admin.component';
import Create from '/pages/module/admin/view/user/entite-administrative-admin/create-admin/entite-administrative-create-admin.component';
import View from '/pages/module/admin/view/user/entite-administrative-admin/view-admin/entite-administrative-view-admin.component';
